...
# ╔═╡ 184e6620-8356-11ec-279a-f9eb6fc418ba
md"""
...
# ╔═╡ 9cade586-81c9-45b6-b564-e2f66cd73e11
begin 
	# test setup
	nx = ny = 12
	X = falses(nx, ny)
...
We can use Pluto and GLMakie to make a nice interactive plot."

# ╔═╡ c48af592-cda6-4b5a-bfea-a17765e4697d
@bind k PlutoUI.Slider(1:n_steps)  # you could use this to create a slider

# ╔═╡ 2c9bb211-e60e-4461-b2ff-711fd6529046
state = X

# ╔═╡ 32074d95-096b-415c-97dc-7e67804c5a31
image(  state,
		interpolate = false,
